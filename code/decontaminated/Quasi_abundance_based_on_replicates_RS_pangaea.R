...
RS_pooled     <- readRDS('data/phyloseq_objects_decontaminated/RSV5_16S_phyloseq_nt_pooled_pangaea_run_decontaminated.rds')
RS_individual <- readRDS('data/phyloseq_objects_decontaminated/RSV5_16S_phyloseq_nt_FALSE_pangaea_run_decontaminated.rds')
RS_pseudo     <- readRDS('data/phyloseq_objects_decontaminated/RSV5_16S_phyloseq_nt_pseudo_pangaea_run_decontaminated.rds')
