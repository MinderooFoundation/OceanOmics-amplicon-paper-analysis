...
RS_pooled     <- readRDS('data/phyloseq_objects_decontaminated/RSV5_16S_pooled_phyloseq_nt_decontaminated.rds')
RS_individual <- readRDS('data/phyloseq_objects_decontaminated/RSV5_16S_individual_phyloseq_nt_decontaminated.rds')
