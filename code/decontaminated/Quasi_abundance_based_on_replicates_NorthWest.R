...
RS_pooled     <- readRDS('data/phyloseq_objects_decontaminated/Pool_TRUE_KWEST_16S_16S_phyloseq_nt_decontaminated.rds')
RS_individual <- readRDS('data/phyloseq_objects_decontaminated/Pool_FALSE_KWEST_16S_16S_phyloseq_nt_decontaminated.rds')
RS_pseudo     <- readRDS('data/phyloseq_objects_decontaminated/Pool_pseudo_KWEST_16S_16S_phyloseq_nt_decontaminated.rds')
